...
public class TesttodoappTest {
  ...
  public void testtodoapp() {
    ...
    {
      WebElement element = driver.findElement(By.cssSelector(".item:nth-child(4) .far"));
      Actions builder = new Actions(driver);
      builder.doubleClick(element).perform();
    }
    driver.findElement(By.cssSelector(".fa-square")).click();
    driver.findElement(By.cssSelector(".item:nth-child(3) .fa")).click();
    driver.findElement(By.cssSelector(".item:nth-child(2) .remove > .btn")).click();
